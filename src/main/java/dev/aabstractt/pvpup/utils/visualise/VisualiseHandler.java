...
public class VisualiseHandler {
    ...
    @Getter private final static @NonNull VisualiseHandler instance = new VisualiseHandler();
    ...
    public LinkedHashMap<Location, VisualBlockData> generate(Player player, ArenaCuboid cuboid, VisualType visualType, boolean canOverwrite) {
    ...
    public void clearVisualBlocks(Chunk chunk) {
        if (storedVisualises.isEmpty()) return;
